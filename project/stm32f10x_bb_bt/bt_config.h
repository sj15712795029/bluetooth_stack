...
#define BT_L2CAP_TRACE_LEVEL 1
#define BT_SDP_TRACE_LEVEL 1
#define BT_RFCOMM_TRACE_LEVEL 1
#define BT_HFP_TRACE_LEVEL 3
#define BT_HSP_TRACE_LEVEL 1
#define BT_OBEX_TRACE_LEVEL 1
#define BT_PBAP_TRACE_LEVEL 1
#define BT_MAP_TRACE_LEVEL 1
#define BT_DID_TRACE_LEVEL 1
#define BT_SPP_TRACE_LEVEL 1
#define BT_AVDTP_TRACE_LEVEL 1
#define BT_AVCTP_TRACE_LEVEL 1
#define BT_A2DP_TRACE_LEVEL 1
#define BT_AVRCP_TRACE_LEVEL 1
