...
typedef void (* sdp_attributes_recv_cb)(void *arg, struct _sdp_pcb_t *pcb, uint16_t attribl_bc,struct bt_pbuf_t *p);
typedef void (* sdp_attributes_searched_cb)(void *arg, struct _sdp_pcb_t *pcb, uint16_t attribl_bc, struct bt_pbuf_t *p);


typedef struct _sdp_record_t {
  struct _sdp_record_t *next; /* For the linked list */
...
typedef struct _sdp_pcb_t {
  struct _sdp_pcb_t *next; /* For the linked list */
  ...
  void *callback_arg;
	...
	sdp_service_searched_cb service_searched;
	sdp_attributes_recv_cb attributes_recv;
	sdp_attributes_searched_cb attributes_searched;
}sdp_pcb_t;
