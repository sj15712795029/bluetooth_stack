...
/* The L2CAP PCB lists. */
extern struct l2cap_pcb_listen_t *l2cap_listen_pcbs; /* List of all L2CAP PCBs in CLOSED state
						but awaing an incoming conn req. */
extern struct l2cap_pcb_t *l2cap_active_pcbs; /* List of all L2CAP PCBs that has
					       established or is about to establish
					       an ACL link */

extern struct l2cap_pcb_t *l2cap_tmp_pcb;      /* Only used for temporary storage. */
