...
#define SHT2X_PERIPH_CLK RCC_APB2Periph_GPIOB
...
#define SHT2X_IIC_SCLK_LOW GPIO_ResetBits(SHT2X_SCL_GPIO,SHT2X_SCL_PIN)
#define SHT2X_IIC_SCLK_HIGH GPIO_SetBits(SHT2X_SCL_GPIO,SHT2X_SCL_PIN)
#define SHT2X_IIC_SDIN_LOW GPIO_ResetBits(SHT2X_SDA_GPIO,SHT2X_SDA_PIN)
#define SHT2X_IIC_SDIN_HIGH GPIO_SetBits(SHT2X_SDA_GPIO,SHT2X_SDA_PIN)
